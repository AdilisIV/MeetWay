...
function StartAPI() {
    ...
    setTimeout(function () {
        for (var j = 0; j < ABC.length; j++) {
            parseDataViaAPI(j, 10);
        }
    }, 800000);
    setTimeout(function () {
        for (var j = 0; j < ABC.length; j++) {
            parseDataViaAPI(j, 11);
        }
    }, 880000);
    setTimeout(function () {
        for (var j = 0; j < ABC.length; j++) {
            parseDataViaAPI(j, 12);
        }
    }, 960000);
    setTimeout(function () {
        for (var j = 0; j < ABC.length; j++) {
            parseDataViaAPI(j, 13);
        }
    }, 1040000);
    setTimeout(function () {
        for (var j = 0; j < ABC.length; j++) {
            parseDataViaAPI(j, 14);
        }
    }, 1120000);
    setTimeout(function () {
        for (var j = 0; j < ABC.length; j++) {
            parseDataViaAPI(j, 15);
        }
    }, 1200000);
    setTimeout(function () {
        for (var j = 0; j < ABC.length; j++) {
            parseDataViaAPI(j, 16);
        }
    }, 1280000);
    setTimeout(function () {
        for (var j = 0; j < ABC.length; j++) {
            parseDataViaAPI(j, 17);
        }
    }, 1360000);
    setTimeout(function () {
        for (var j = 0; j < ABC.length; j++) {
            parseDataViaAPI(j, 18);
        }
    }, 1440000);
    setTimeout(function () {
        for (var j = 0; j < ABC.length; j++) {
            parseDataViaAPI(j, 19);
        }
    }, 1520000);
    //}
}
