...
function parseDataFromSite(c) {
    return function () {
        nightmare.goto('https://vk.com/search?c%5Bcity%5D=' + CitiesID[c] + '&c%5Bcountry%5D=1&c%5Bsection%5D=communities&c%5Bskip_catalog%5D=1&c%5Btype%5D=3').wait(2000) // c
        .inject('js', './jquery_v1_10_2.js').wait(2000).scrollTo(9999999999999999999999999999999, 0).wait(5000).evaluate(function () {
            var shortNames = [];
