...
function asyncNightmare() {
    ...
    var urls = ['https://vk.com/search?c%5Bcity%5D=96&c%5Bcountry%5D=1&c%5Bnot_safe%5D=1&c%5Bsection%5D=communities&c%5Btype%5D=3', 'https://vk.com/search?c%5Bcity%5D=49&c%5Bcountry%5D=1&c%5Bnot_safe%5D=1&c%5Bsection%5D=communities&c%5Btype%5D=3', 'https://vk.com/search?c%5Bcity%5D=153&c%5Bcountry%5D=1&c%5Bnot_safe%5D=1&c%5Bsection%5D=communities&c%5Btype%5D=3'];
    urls.reduce(function (accumulator, url) {
        return accumulator.then(function (results) {
            return nightmare.goto(url).wait('body').wait(15000)
            //.title()
            .inject('js', './../jquery_v1_10_2.js').wait(1500).inject('js', './../scrollAnimate.js').wait(15000)
...
function login() {
    nightmare.goto('https://vk.com/login').wait(1000).type('form [name=email]', email).click('input#pass').type('input#pass', password).click('button#login_button').wait(4000);
}
...
//# sourceMappingURL=asincNightmare-compiled.js.map