(function e(t, n, r) {
  function s(o, u) {
        ...
        keys(o).map(function (k, i) {
          o[k].call(context, args, function (err, args) {
            ...
            if (! --pending) {
              ...
              return errors.length ? done(error(errors), out) : done(null, out);
            }
          });
        });
      };
    ...
    function exit(args) {
      return args.length && (typeof args[0] === 'undefined' || args[0] === null);
    }
    ...
    function Stack(stack, context, args, done) {
      ...
      function error(err) {
        var fn = stack.shift();
        while (fn && fn.__catch__ !== true) fn = stack.shift();
        if (fn) return fn.call(context, err, args, next);else return done.call(context, err);
      }
    ...
    function type(v) {
      return isArray(v) ? 'array' : v && v.__catch__ ? 'catch' : v && v.vo ? 'vo' : v && typeof v.next === 'function' && typeof v.throw === 'function' ? 'generator' : v && typeof v.then === 'function' && typeof v.catch === 'function' ? 'promise' : v === null ? 'null' : typeof v;
    }
    ...
    function generator(value) {
      return value && value.constructor && 'GeneratorFunction' == value.constructor.name || typeof value.next === 'function' && typeof value.throw === 'function';
    }
...
//# sourceMappingURL=vo-compiled.js.map