 ...
 * @type {number[]}
 */
CronExpression.daysInMonth = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
...
CronExpression._parseField = function _parseField(field, value, constraints) {
  ...
  function parseRange(val, repeatInterval) {
    ...
    if (atoms.length > 1) {
      ...
      if (Number.isNaN(min) || Number.isNaN(max) || min < constraints[0] || max > constraints[1]) {
  ...
  function parse(expression, options) {
    ...
    for (var i = 0, c = CronExpression.map.length; i < c; ++i) {
      ...
      if (i < start || !value) {
        ...
        // Use default value
        fields.push(CronExpression._parseField(field, value, CronExpression.constraints[i]));
      }
    }
